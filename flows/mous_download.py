...
def launch_download_headless_session(job_name: str, img: str, cmd: str, tmpdir: str, url: str, db_path: str, mous_id: str):
    log = get_run_logger()
...
def launch_download_job_task(mous_id: str, url: str, download_dir: str, db_path: str):
    ...
    job_id = launch_download_headless_session(job_name, WGET2_IMAGE, run_download_script_filepath, platform_tmpdir, url, platform_db_path, mous_id)
